...
!(function (e, r) {
  ...
  function H(e, r) {
    if (!St(e)) throw new TypeError(r + " is not a ReadableStream.");
  }
  function V(e) {
    return new $(e);
  }
  ...
  var K,
    ...
    $ = (function () {
      function e(e) {
        if (
          (D(e, 1, "ReadableStreamDefaultReader"),
          H(e, "First parameter"),
          Rt(e))
        )
          throw new TypeError(
        ...
        R(this, e), (this._readRequests = new S());
      }
      return (
        Object.defineProperty(e.prototype, "closed", {
          get: function () {
            return ee(this) ? this._closedPromise : d(te("closed"));
          },
          enumerable: !1,
          configurable: !0,
        }),
        ...
        (e.prototype.read = function () {
          if (!ee(this)) return d(te("read"));
          if (void 0 === this._ownerReadableStream) return d(q("read from"));
          var e,
            r,
            t = c(function (t, o) {
              (e = t), (r = o);
  ...
  function re(e, r) {
    ...
    (t._disturbed = !0),
      "closed" === t._state
        ...
        : t._readableStreamController[z](r);
  }
  function te(e) {
  ...
  var oe = (function () {
      ...
      return (
        ...
        (e.prototype._nextSteps = function () {
          ...
          var r,
            t,
            o = this._reader;
          if (void 0 === o._ownerReadableStream) return d(q("iterate"));
          ...
          return (
            re(o, {
              ...
              _errorSteps: function (r) {
                (e._ongoingPromise = void 0), (e._isFinished = !0), P(o), t(r);
              },
            }),
            n
          );
    ...
    ne = {
      next: function () {
        return ie(this) ? this._asyncIteratorImpl.next() : d(ae("next"));
      },
      return: function (e) {
        return ie(this) ? this._asyncIteratorImpl.return(e) : d(ae("return"));
      },
    };
  function ie(e) {
    if (!n(e)) return !1;
  ...
  function be(e, r, t) {
    if ("number" != typeof (o = t) || ue(o) || o < 0 || t === 1 / 0)
  ...
  var _e = (function () {
    ...
    return (
      ...
      (e.prototype.respond = function (e) {
        if (!ye(this)) throw De("respond");
        if (
          (D(e, 1, "respond"),
          (e = Y(e, "First parameter")),
          void 0 === this._associatedReadableByteStreamController)
        )
          throw new TypeError("This BYOB request has been invalidated");
        this._view.buffer, Fe(this._associatedReadableByteStreamController, e);
      }),
      (e.prototype.respondWithNewView = function (e) {
        if (!ye(this)) throw De("respondWithNewView");
        if ((D(e, 1, "respondWithNewView"), !ArrayBuffer.isView(e)))
  ...
  var he = (function () {
    ...
    return (
      Object.defineProperty(e.prototype, "byobRequest", {
        get: function () {
          if (!ve(this)) throw xe("byobRequest");
          return Be(this);
        },
        enumerable: !1,
        configurable: !0,
      ...
      Object.defineProperty(e.prototype, "desiredSize", {
        get: function () {
          if (!ve(this)) throw xe("desiredSize");
          return Ie(this);
        },
        enumerable: !1,
        configurable: !0,
      ...
      (e.prototype.enqueue = function (e) {
        if (!ve(this)) throw xe("enqueue");
        if ((D(e, 1, "enqueue"), !ArrayBuffer.isView(e)))
      ...
      (e.prototype.error = function (e) {
        if ((void 0 === e && (e = void 0), !ve(this))) throw xe("error");
        ze(this, e);
      }),
      ...
      (e._pulling
        ...
        : ((e._pulling = !0),
          p(
            e._pullAlgorithm(),
            function () {
              (e._pulling = !1), e._pullAgain && ((e._pullAgain = !1), me(e));
            },
            function (r) {
              ze(e, r);
            }
  ...
  function ge(e) {
    Ce(e), (e._pendingPullIntos = new S());
  }
  function we(e, r) {
    var t = !1;
    "closed" === e._state && (t = !0);
  ...
  function Te(e, r) {
    ...
    for (var s = e._queue; u > 0; ) {
      var c = s.peek(),
        f = Math.min(u, c.byteLength),
        d = r.byteOffset + r.bytesFilled;
      se(r.buffer, d, c.buffer, c.byteOffset, f),
        c.byteLength === f
          ? s.shift()
          : ((c.byteOffset += f), (c.byteLength -= f)),
        (e._queueTotalSize -= f),
        Pe(e, f, r),
        (u -= f);
    }
  ...
  function qe(e) {
    0 === e._queueTotalSize && e._closeRequested
      ? (ke(e), Pt(e._controlledReadableByteStream))
      : me(e);
  }
  function Ce(e) {
    null !== e._byobRequest &&
  ...
  function Ee(e) {
    for (; e._pendingPullIntos.length > 0; ) {
      ...
      Te(e, r) && (je(e), we(e._controlledReadableByteStream, r));
    }
  }
  function Oe(e, r) {
    ...
    Ce(e),
      "closed" === e._controlledReadableByteStream._state
        ? (function (e, r) {
            ...
            if (He(t)) for (; Ye(t) > 0; ) we(t, je(e));
          })(e)
        : (function (e, r, t) {
            if ((Pe(0, r, t), !(t.bytesFilled < t.elementSize))) {
              je(e);
  ...
  function Ae(e, r) {
    ...
    if (!e._closeRequested && "readable" === t._state) {
      var o = r.buffer,
        ...
        a = o;
      if (e._pendingPullIntos.length > 0) {
        var u = e._pendingPullIntos.peek();
        u.buffer, 0, (u.buffer = u.buffer);
      }
      if ((Ce(e), J(t)))
        if (0 === X(t)) Re(e, a, n, i);
        else
          e._pendingPullIntos.length > 0 && je(e),
            G(t, new Uint8Array(a, n, i), !1);
      else He(t) ? (Re(e, a, n, i), Ee(e)) : Re(e, a, n, i);
      me(e);
    }
  }
  function ze(e, r) {
    var t = e._controlledReadableByteStream;
    "readable" === t._state && (ge(e), pe(e), ke(e), qt(t, r));
  }
  function Be(e) {
  ...
  function Le(e, r) {
    ...
    var o = r.byteLength;
    (t.buffer = r.buffer), Oe(e, o);
  }
  function Me(e, r, t, o, n, i, a) {
  ...
  var Ve = (function () {
    function e(e) {
      if ((D(e, 1, "ReadableStreamBYOBReader"), H(e, "First parameter"), Rt(e)))
        throw new TypeError(
          "This stream has already been locked for exclusive reading by another reader"
        );
      if (!ve(e._readableStreamController))
        throw new TypeError(
          "Cannot construct a ReadableStreamBYOBReader for a stream not constructed with a byte source"
        );
      R(this, e), (this._readIntoRequests = new S());
    }
    return (
      Object.defineProperty(e.prototype, "closed", {
        get: function () {
          return Ue(this) ? this._closedPromise : d(Xe("closed"));
        },
        enumerable: !1,
        configurable: !0,
      }),
    ...
    (o._disturbed = !0),
      "errored" === o._state
        ...
        : (function (e, r, t) {
            ...
            if (e._pendingPullIntos.length > 0)
              return e._pendingPullIntos.push(u), void Qe(o, t);
            if ("closed" !== o._state) {
              if (e._queueTotalSize > 0) {
                if (Te(e, u)) {
                  var l = Se(u);
                  return qe(e), void t._chunkSteps(l);
                }
                if (e._closeRequested) {
                  var s = new TypeError(
                    "Insufficient bytes to fill elements in the given buffer"
                  );
                  return ze(e, s), void t._errorSteps(s);
                }
              }
              e._pendingPullIntos.push(u), Qe(o, t), me(e);
            } else {
              var c = new i(u.buffer, u.byteOffset, 0);
              t._closeSteps(c);
            }
  ...
  var ir = "function" == typeof AbortController;
  var ar = (function () {
    function e(e, r) {
      void 0 === e && (e = {}),
        void 0 === r && (r = {}),
      ...
      var t = Ze(r, "Second parameter"),
        o = (function (e, r) {
          ...
          return {
            ...
            write:
              void 0 === a ? void 0 : or(a, e, r + " has member 'write' that"),
            type: i,
          };
        })(e, "First parameter");
      if ((lr(this), void 0 !== o.type))
        throw new RangeError("Invalid type is specified");
      var n = Ke(t);
      !(function (e, r, t, o) {
        var n = Object.create(Cr.prototype),
          i = function () {},
          a = function () {
            return f(void 0);
          },
  ...
  function fr(e, r) {
    ...
    return (e._pendingAbortRequest._promise = i), n || pr(e, r), i;
  }
  function dr(e) {
    var r = e._state;
    ...
    return (
      ...
      be((t = e._writableStreamController), qr, 0),
      Wr(t),
      o
    );
  }
  ...
  function _r(e) {
    ...
    if (
      ...
      if (((e._pendingAbortRequest = void 0), t._wasAlreadyErroring))
        return t._reject(r), void vr(e);
      p(
        e._writableStreamController[k](t._reason),
        function () {
          t._resolve(), vr(e);
        },
        function (r) {
  ...
  Object.defineProperties(ar.prototype, {
    ...
    "symbol" == typeof r.toStringTag &&
      Object.defineProperty(ar.prototype, r.toStringTag, {
  ...
  var mr = (function () {
    function e(e) {
      if (
        (D(e, 1, "WritableStreamDefaultWriter"),
      ...
      var r,
        t = e._state;
      if ("writable" === t)
        !hr(e) && e._backpressure ? Yr(this) : Vr(this), Dr(this);
      else if ("erroring" === t) Hr(this, e._storedError), Dr(this);
      else if ("closed" === t) Vr(this), Dr((r = this)), Qr(r);
      else {
    ...
    return (
      Object.defineProperty(e.prototype, "closed", {
        get: function () {
          return gr(this) ? this._closedPromise : d(Lr("closed"));
        },
        enumerable: !1,
        configurable: !0,
      }),
      Object.defineProperty(e.prototype, "desiredSize", {
        get: function () {
          if (!gr(this)) throw Lr("desiredSize");
          if (void 0 === this._ownerWritableStream) throw Mr("desiredSize");
          return (function (e) {
      ...
      Object.defineProperty(e.prototype, "ready", {
        get: function () {
          return gr(this) ? this._readyPromise : d(Lr("ready"));
        },
        enumerable: !1,
        configurable: !0,
      }),
        ...
        return (
          ...
          gr(this)
            ? void 0 === this._ownerWritableStream
              ? d(Mr("abort"))
              : (function (e, r) {
                  return fr(e._ownerWritableStream, r);
                })(this, e)
            : d(Lr("abort"))
        );
      }),
      (e.prototype.close = function () {
        if (!gr(this)) return d(Lr("close"));
      ...
      (e.prototype.releaseLock = function () {
        if (!gr(this)) throw Lr("releaseLock");
  ...
  function wr(e) {
    return dr(e._ownerWritableStream);
  }
  function Sr(e, r) {
  ...
  function Tr(e) {
    ...
    Rr(e, t), Sr(e, t), (r._writer = void 0), (e._ownerWritableStream = void 0);
  }
  function Pr(e, r) {
    ...
    if (t !== e._ownerWritableStream) return d(Mr("write to"));
    var i = t._state;
    if ("errored" === i) return d(t._storedError);
    if (hr(t) || "closed" === i)
      return d(
        new TypeError(
    ...
    if ("erroring" === i) return d(t._storedError);
    var a = (function (e) {
  ...
  Object.defineProperties(mr.prototype, {
    ...
    "symbol" == typeof r.toStringTag &&
      Object.defineProperty(mr.prototype, r.toStringTag, {
    ...
    Cr = (function () {
      ...
      return (
        Object.defineProperty(e.prototype, "abortReason", {
          get: function () {
            if (!Er(this)) throw Fr("abortReason");
        ...
        (e.prototype.error = function (e) {
          if ((void 0 === e && (e = void 0), !Er(this))) throw Fr("error");
          "writable" === this._controlledWritableStream._state && Br(this, e);
        }),
  ...
  function Or(e, r, t, o, n, i, a, u) {
    (r._controlledWritableStream = e),
      ...
      (r._abortController = (function () {
        if (ir) return new AbortController();
      })()),
      (r._started = !1),
  ...
  function Ar(e, r) {
    "writable" === e._controlledWritableStream._state && Br(e, r);
  }
  function zr(e) {
    return kr(e) <= 0;
  }
  ...
  Object.defineProperties(Cr.prototype, {
    ...
    "symbol" == typeof r.toStringTag &&
      Object.defineProperty(Cr.prototype, r.toStringTag, {
  ...
  var Jr,
    Kr = (function (e) {
      ...
      : (((Jr = function (e, r) {
        ...
        Jr);
  function Zr(e, r, o, n, i, a) {
    var u = V(e),
      l = ur(r);
    e._disturbed = !0;
    var s = !1,
      v = f(void 0);
    return c(function (m, g) {
      var w, S, R, T;
      if (void 0 !== a) {
        if (
          ((w = function () {
            ...
            n ||
              o.push(function () {
                return "writable" === r._state ? fr(r, t) : f(void 0);
              }),
              i ||
                o.push(function () {
                  return "readable" === e._state ? Tt(e, t) : f(void 0);
                }),
              O(
                function () {
                  return Promise.all(
      ...
      if (
        (E(e, u._closedPromise, function (e) {
          n
            ? j(!0, e)
            : O(
                function () {
        ...
        E(r, l._closedPromise, function (r) {
          i
            ? j(!0, r)
            : O(
                function () {
      ...
      function O(e, t, o) {
        ...
        s || ((s = !0), "writable" !== r._state || hr(r) ? n() : _(C(), n));
      }
      function j(e, t) {
        s ||
          ((s = !0),
      ...
      function k(e, r) {
        Tr(l),
          P(u),
          void 0 !== a && a.removeEventListener("abort", w),
          e ? g(r) : m(void 0);
      }
      y(
        c(function (e, r) {
          !(function o(n) {
            n
              ...
              : b(
                  s
                    ? f(!0)
                    : b(l._readyPromise, function () {
                        return c(function (e, r) {
                          re(u, {
                            _chunkSteps: function (r) {
                              (v = b(Pr(l, r), void 0, t)), e(!1);
                            },
                            _closeSteps: function () {
                              return e(!0);
                            },
  ...
  function tt(e) {
    ...
    return !!lt(e) && !!e._started && (!!(Rt(r) && X(r) > 0) || ut(e) > 0);
  }
  function ot(e) {
  ...
  function nt(e) {
    if (lt(e)) {
      var r = e._controlledReadableStream;
      (e._closeRequested = !0), 0 === e._queue.length && (ot(e), Pt(r));
    }
  }
  function it(e, r) {
    if (lt(e)) {
  ...
  function at(e, r) {
    var t = e._controlledReadableStream;
    "readable" === t._state && (pe(e), ot(e), qt(t, r));
  }
  function ut(e) {
  ...
  function ft(e, r) {
    return ve(e._readableStreamController)
      ? (function (e) {
          var r,
            t,
            o,
          ...
          function _(e) {
            h(e._closedPromise, function (r) {
              e === a &&
                (ze(o._readableStreamController, r),
                ze(n._readableStreamController, r),
                (d && b) || i(void 0));
            });
          }
          function v() {
              ...
              re(a, {
                _chunkSteps: function (r) {
                  m(function () {
                    ...
                    d || Ae(o._readableStreamController, t),
                      b || Ae(n._readableStreamController, a),
                      (u = !1),
                      l ? g() : s && w();
                  });
                },
                _closeSteps: function () {
                  (u = !1),
                    d || We(o._readableStreamController),
                    b || We(n._readableStreamController),
                    o._readableStreamController._pendingPullIntos.length > 0 &&
                      Fe(o._readableStreamController, 0),
                    n._readableStreamController._pendingPullIntos.length > 0 &&
                      Fe(n._readableStreamController, 0),
                    (d && b) || i(void 0);
                },
            ...
            Ge(a, r, {
              _chunkSteps: function (r) {
                m(function () {
                  (l = !1), (s = !1);
                  var o = t ? b : d;
                  if (t ? d : b) o || Le(c._readableStreamController, r);
                  else {
                    var n = void 0;
                    try {
                      n = fe(r);
                      ...
                      return (
                        ze(c._readableStreamController, r),
                        ze(f._readableStreamController, r),
                        void i(Tt(e, r))
                      );
                    }
                    o || Le(c._readableStreamController, r),
                      Ae(f._readableStreamController, n);
                  }
                  (u = !1), l ? g() : s && w();
                });
              },
              _closeSteps: function (e) {
                ...
                var r = t ? b : d,
                  o = t ? d : b;
                r || We(c._readableStreamController),
                  o || We(f._readableStreamController),
                  void 0 !== e &&
                    (r || Le(c._readableStreamController, e),
                    !o &&
                      f._readableStreamController._pendingPullIntos.length >
                        0 &&
                      Fe(f._readableStreamController, 0)),
                  (r && o) || i(void 0);
              },
              _errorSteps: function () {
                u = !1;
          ...
          function g() {
            if (u) return (l = !0), f(void 0);
            u = !0;
            var e = Be(o._readableStreamController);
            return null === e ? v() : y(e._view, !1), f(void 0);
          }
          function w() {
            if (u) return (s = !0), f(void 0);
            u = !0;
            var e = Be(n._readableStreamController);
            return null === e ? v() : y(e._view, !0), f(void 0);
          }
          function S(o) {
            if (((d = !0), (r = o), b)) {
              var n = le([r, t]),
          ...
          function T() {}
          return (o = gt(T, g, S)), (n = gt(T, w, R)), _(a), [o, n];
        })(e)
      : (function (e, r) {
          var t,
            o,
                ...
                re(u, {
                  _chunkSteps: function (e) {
                    m(function () {
                      ...
                      var r = e,
                        t = e;
                      d || it(n._readableStreamController, r),
                        b || it(i._readableStreamController, t),
                        (l = !1),
                        s && _();
                    });
                  },
                  _closeSteps: function () {
                    (l = !1),
                      d || nt(n._readableStreamController),
                      b || nt(i._readableStreamController),
                      (d && b) || a(void 0);
                  },
                  _errorSteps: function () {
                    l = !1;
          ...
          return (
            (n = mt(g, _, v)),
            (i = mt(g, _, y)),
            h(u._closedPromise, function (e) {
              at(n._readableStreamController, e),
                at(i._readableStreamController, e),
                (d && b) || a(void 0);
            }),
            [n, i]
          );
  ...
  var yt = (function () {
      ...
      var t = Ze(r, "Second parameter"),
        o = (function (e, r) {
          ...
          var t = e,
            ...
            i = null == t ? void 0 : t.pull,
            a = null == t ? void 0 : t.start,
            u = null == t ? void 0 : t.type;
          return {
            autoAllocateChunkSize:
              void 0 === o
                ? void 0
                : Y(o, r + " has member 'autoAllocateChunkSize' that"),
            cancel:
              void 0 === n ? void 0 : dt(n, t, r + " has member 'cancel' that"),
            pull:
              void 0 === i ? void 0 : bt(i, t, r + " has member 'pull' that"),
            start:
              void 0 === a ? void 0 : pt(a, t, r + " has member 'start' that"),
            type: void 0 === u ? void 0 : _t(u, r + " has member 'type' that"),
          };
        })(e, "First parameter");
      if ((wt(this), "bytes" === o.type)) {
        if (void 0 !== t.size)
          throw new RangeError(
    ...
    return (
      ...
      (e.prototype.getReader = function (e) {
        if ((void 0 === e && (e = void 0), !St(this))) throw Ct("getReader");
        return void 0 ===
          (function (e, r) {
            F(e, r);
      ...
      (e.prototype.pipeThrough = function (e, r) {
        if ((void 0 === r && (r = {}), !St(this))) throw Ct("pipeThrough");
        D(e, 1, "pipeThrough");
        var t = (function (e, r) {
            F(e, r);
            var t = null == e ? void 0 : e.readable;
            x(t, "readable", "ReadableWritablePair"),
      ...
      (e.prototype.pipeTo = function (e, r) {
        if ((void 0 === r && (r = {}), !St(this))) return d(Ct("pipeTo"));
      ...
      (e.prototype.tee = function () {
        if (!St(this)) throw Ct("tee");
        return le(ft(this));
      }),
      (e.prototype.values = function (e) {
        if ((void 0 === e && (e = void 0), !St(this))) throw Ct("values");
        var r,
          t,
          o,
          n,
        ...
        return (
          ...
          (o = V(r)),
          (n = new oe(o, t)),
          ((i = Object.create(ne))._asyncIteratorImpl = n),
          i
        );
      }),
      e
  ...
  function mt(e, r, t, o, n) {
    ...
    var i = Object.create(yt.prototype);
    return wt(i), st(i, Object.create($r.prototype), e, r, t, o, n), i;
  }
  function gt(e, r, t) {
    var o = Object.create(yt.prototype);
    return wt(o), Me(o, Object.create(he.prototype), e, r, t, 0, void 0), o;
  }
  function wt(e) {
    (e._state = "readable"),
      (e._reader = void 0),
  ...
  function Tt(e, r) {
    ...
    return (
      ...
      v(e._readableStreamController[A](r), t)
    );
  }
  function Pt(e) {
    e._state = "closed";
  ...
  function Et(e, r) {
    ...
    var t = null == e ? void 0 : e.highWaterMark;
    return (
      x(t, "highWaterMark", "QueuingStrategyInit"), { highWaterMark: N(t) }
    );
  }
  ...
  try {
    Object.defineProperty(Ot, "name", { value: "size", configurable: !0 });
  } catch (K) {}
  var jt = (function () {
    function e(e) {
      D(e, 1, "ByteLengthQueuingStrategy"),
        (e = Et(e, "First parameter")),
        (this._byteLengthQueuingStrategyHighWaterMark = e.highWaterMark);
    }
    return (
      Object.defineProperty(e.prototype, "highWaterMark", {
        get: function () {
          if (!Wt(this)) throw kt("highWaterMark");
  ...
  Object.defineProperties(jt.prototype, {
    ...
    "symbol" == typeof r.toStringTag &&
      Object.defineProperty(jt.prototype, r.toStringTag, {
  ...
  try {
    Object.defineProperty(At, "name", { value: "size", configurable: !0 });
  } catch (K) {}
  var zt = (function () {
    function e(e) {
      D(e, 1, "CountQueuingStrategy"),
        (e = Et(e, "First parameter")),
    ...
    return (
      Object.defineProperty(e.prototype, "highWaterMark", {
        get: function () {
          if (!It(this)) throw Bt("highWaterMark");
  ...
  Object.defineProperties(zt.prototype, {
    ...
    "symbol" == typeof r.toStringTag &&
      Object.defineProperty(zt.prototype, r.toStringTag, {
    ...
    function e(e, r, t) {
      ...
      var o = Ze(r, "Second parameter"),
        ...
        i = (function (e, r) {
          ...
          return {
            flush:
              void 0 === t ? void 0 : Ft(t, e, r + " has member 'flush' that"),
            readableType: o,
            start:
              void 0 === n ? void 0 : Lt(n, e, r + " has member 'start' that"),
            transform:
              void 0 === i
                ? void 0
                : Mt(i, e, r + " has member 'transform' that"),
            writableType: a,
          };
        })(e, "First parameter");
      ...
      !(function (e, r, t, o, n, i) {
        ...
        function u(r) {
          return (function (e, r) {
            ...
            if (e._backpressure) {
              return v(e._backpressureChangePromise, function () {
                var o = e._writable;
        ...
        function d(r) {
          return Qt(e, r), f(void 0);
        }
        (e._writable = (function (e, r, t, o, n, i) {
          void 0 === n && (n = 1),
            void 0 === i &&
              (i = function () {
                return 1;
          ...
          return lr(a), Or(a, Object.create(Cr.prototype), e, r, t, o, n, i), a;
        })(a, u, s, l, t, o)),
          (e._readable = mt(a, c, d, n, i)),
        ...
        void 0 !== i.start
          ? a(i.start(this._transformStreamController))
          : a(void 0);
    }
    return (
      Object.defineProperty(e.prototype, "readable", {
        get: function () {
          if (!xt(this)) throw Kt("readable");
  ...
  function Nt(e, r) {
    at(e._readable._readableStreamController, r), Qt(e, r);
  }
  function Qt(e, r) {
    Ut(e._transformStreamController),
      Ar(e._writable._writableStreamController, r),
  ...
  Object.defineProperties(Dt.prototype, {
    ...
    "symbol" == typeof r.toStringTag &&
      Object.defineProperty(Dt.prototype, r.toStringTag, {
  ...
  var Ht = (function () {
    ...
    return (
      ...
      (e.prototype.error = function (e) {
        ...
        var r;
        (r = e), Nt(this._controlledTransformStream, r);
      }),
  ...
  function Gt(e, r) {
    ...
    try {
      ...
      throw (Qt(t, e), t._readable._storedError);
    }
    var n = (function (e) {
      return !tt(e);
    })(o);
    n !== t._backpressure && Yt(t, !0);
  }
  function Xt(e, r) {
    return v(e._transformAlgorithm(r), void 0, function (r) {
      throw (Nt(e._controlledTransformStream, r), r);
    });
  }
  function Jt(e) {
    return new TypeError(
  ...
  Object.defineProperties(Ht.prototype, {
    ...
    (e.ByteLengthQueuingStrategy = jt),
    (e.CountQueuingStrategy = zt),
    ...
    (e.TransformStream = Dt),
    (e.TransformStreamDefaultController = Ht),
    (e.WritableStream = ar),
    (e.WritableStreamDefaultController = Cr),
    (e.WritableStreamDefaultWriter = mr),
