...
((e, t) => {
  ...
  let e = null,
    t = !1;
  const a = window.WebStreamsPolyfill || {},
    r = window.isSecureContext;
  let n = /constructor/i.test(window.HTMLElement) || !!window.safari;
  const o =
      r || "MozAppearance" in document.documentElement.style
        ? "iframe"
        : "navigate",
    s = {
      createWriteStream: function (a, l, d) {
        let m = {
          size: null,
          pathname: null,
        ...
        if (!n) {
          e ||
            (e = r
              ...
              : (function (e) {
                  ...
                  return window.addEventListener("message", r), a;
                })(s.mitm));
          var c = 0,
            p = null,
          ...
          a = encodeURIComponent(a.replace(/\//g, ":"))
            ...
            .replace(/\*/g, "%2A");
          const n = {
            transferringReadable: t,
            pathname:
              m.pathname || Math.random().toString().slice(-6) + "/" + a,
            headers: {
              "Content-Type": "application/octet-stream; charset=utf-8",
              "Content-Disposition": "attachment; filename*=UTF-8''" + a,
            },
          };
          m.size && (n.headers["Content-Length"] = m.size);
          const l = [n, "*", [w.port2]];
          if (t) {
            const e =
              "iframe" === o
                ...
                : {
                    transform(e, t) {
                      (c += e.length),
                        t.enqueue(e),
                        p && ((location.href = p), (p = null));
                    },
                    flush() {
                      p && (location.href = p);
                    },
                  };
            var u = new s.TransformStream(
              e,
              m.writableStrategy,
              m.readableStrategy
            );
            const t = u.readable;
            w.port1.postMessage({ readableStream: t }, [t]);
          }
          (w.port1.onmessage = (t) => {
            t.data.download &&
              ("navigate" === o
                ? (e.remove(),
                  (e = null),
                  c ? (location.href = t.data.download) : (p = t.data.download))
                : (e.isPopup && (e.remove(), "iframe" === o && i(s.mitm)),
                  i(t.data.download)));
          }),
            e.loaded
              ? e.postMessage(...l)
              ...
              close() {
                if (n) {
                  ...
                  (t.href = URL.createObjectURL(e)),
                    (t.download = a),
                    t.click();
                } else w.port1.postMessage("end");
              },
              abort() {
                (f = []),
                  w.port1.postMessage("abort"),
                  (w.port1.onmessage = null),
                  w.port1.close(),
                  w.port2.close(),
                  (w = null);
              },
      ...
      WritableStream: window.WritableStream || a.WritableStream,
      supported: !0,
  ...
  try {
    new Response(new ReadableStream()),
      !r || "serviceWorker" in navigator || (n = !0);
  } catch (e) {
    n = !0;
  }
  return (
